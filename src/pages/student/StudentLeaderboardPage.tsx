        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 p-1.5 rounded-2xl bg-slate-900 border border-slate-800">
          <div className="flex items-center gap-2 overflow-x-auto w-full sm:w-auto custom-scrollbar">
            <button
              ...
              className={clsx(
                "flex items-center gap-2 px-4 py-2 rounded-xl font-bold transition-all text-xs cursor-pointer whitespace-nowrap",
                scope === 'national'
            ...
            >
              ...
              <span>🏛️ Respublika Reytingi</span>
            </button>
            ...
            >
              ...
              <span>🏙️ Viloyat Kesimidagi Reyting</span>
            </button>
            ...
            >
              ...
              <span>🏫 Tuman Kesimidagi Reyting</span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-1 shrink-0">
            <button
              ...
              className={clsx(
                "px-3 py-1.5 rounded-xl font-bold text-xs cursor-pointer transition-all border",
                limitMode === 'top20'
          ...
          <div className="p-3 rounded-xl bg-blue-950/60 border border-blue-500/40 flex items-center justify-between text-xs">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-blue-200">
                Tanlangan Viloyat Reytingi: <span className="text-white underline">{regionFilter === 'all' ? 'Toshkent shahri' : regionFilter}</span>
              </span>
            </div>
            <span className="text-[11px] text-slate-400 font-medium">
              Pastki menyudan istalgan viloyatni tanlashingiz mumkin
            </span>
          </div>
        )}
          ...
          <div className="p-3 rounded-xl bg-purple-950/60 border border-purple-500/40 flex items-center justify-between text-xs">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-purple-200">
                Tanlangan Tuman Reytingi: <span className="text-white underline">{districtFilter === 'all' ? 'Yunusobod tumani' : districtFilter}</span> ({regionFilter})
              </span>
            </div>
            <span className="text-[11px] text-slate-400 font-medium">
              Pastki menyudan istalgan tumanni tanlashingiz mumkin
            </span>
          </div>
        )}
